...
import { FloatingDateField, FloatingSelectField } from './floatingFields'
...
export function GlobalFilterModal({ open, onClose }: GlobalFilterModalProps) {
  const titleId = useId()
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="relative z-10 w-full max-w-3xl rounded-2xl border border-slate-200/80 bg-white shadow-2xl dark:border-slate-700 dark:bg-slate-900"
      ...
      >
        <div className="flex items-start justify-between gap-4 border-b border-dashed border-slate-200 px-6 py-4 dark:border-slate-700">
          ...
          <button
            ...
            aria-label="Close global filter"
          >
